...
.gh-table th, .gh-table td {{ padding:7px 9px; text-align:center; white-space:nowrap; }}
...
.gh-cell {{ font-variant-numeric:tabular-nums; font-weight:600; min-width:42px; }}
...
/* heat shading reused on the standings data-table — matched to .proj-cell:
   flat full-bleed fill (no border-radius → no "diamond" notches between cells),
